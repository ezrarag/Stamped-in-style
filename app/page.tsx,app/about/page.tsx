...
export default function AboutPage() {
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/hero-desert.jpg')",
        backgroundSize: "cover",
      }}
    >
      <div className="absolute top-0 left-0 w-full h-full bg-black/40" />
      <div className="relative z-10 flex flex-col items-center">
        <div className="w-12 h-12 rounded-full border-white/30 flex items-center justify-center bg-white/20 backdrop-blur-sm">
          <Image src="/next.svg" alt="Next.js Logo" width={40} height={40} />
        </div>
        <h1 className="text-5xl font-bold mt-4">About Me</h1>
        <p className="text-lg mt-2 text-center">
          This is a simple about page created with Next.js and Tailwind CSS.
        </p>
      </div>
    </div>
  );
